            ...
            <div class="row gx-5">
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        ...
                        <p align="left" class="mt-3 mb-4">
                            Shivaay Creations is a leading technology solutions provider and authorized partner of renowned telecom operators and IT service providers.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">contact@shivaaycreations.in</p>
                            </div>
                            <div class="d-flex mb-2">
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">
                            &copy; <a class="text-white border-bottom" href="https://shivaaycreations.in/">Shivaay Creations</a>. All Rights Reserved.
                        </p>
                    </div>
                </div>
            </div>
